    ...
    <div class="flex flex-row">
      <div class="flex-1">
        <div class="flex flex-col h-screen items-center justify-center">
          <img src="../../../assets/images/logo.png" alt="" class="w-max drop-shadow-lg py-10" />
          <div class="w-full max-w-md space-y-5 px-2">
            ...
            <router-link to="/home/overview"> <PrimaryButton class="mt-5" value="Login" custom-color="bg-[#06A6D8]" /></router-link>"
          </div>
        </div>
      </div>
